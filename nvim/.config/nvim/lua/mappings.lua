...
nomap("n", "<leader>x")
map("n", "<leader>q", require("nvchad.tabufline").close_buffer, { desc = "Close buffer" })
...
map({ "n", "v", "t" }, "<C-j>", "<cmd>NvimTmuxNavigateDown<CR>", { desc = "Window down" })
map({ "n", "v", "t" }, "<C-k>", "<cmd>NvimTmuxNavigateUp<CR>", { desc = "Window up" })
map({ "n", "v", "t" }, "<C-l>", "<Cmd>NvimTmuxNavigateRight<CR>", { desc = "Window right" })
map({ "n", "v", "t" }, "<C-\\>", "<Cmd>NvimTmuxNavigateLastActive<CR>", { desc = "Window up" })
